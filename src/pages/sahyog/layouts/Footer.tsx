...
export default function Footer() {
  ...
  return (
    <>
      <footer
        className="bg-[#0b1329] text-slate-300 pt-14 pb-8 border-t border-slate-800 text-xs"
        id="contact"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          {/* Main 3-Column Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-10 border-b border-slate-800/80">
            {/* Column 1: Bihar Sahyog Helpline Description */}
              ...
              <div className="flex items-start gap-2.5 text-slate-400">
                ...
                <p className="leading-relaxed">
                  <strong className="text-white font-medium">
                    {t.footer.addressText[0]}
                  </strong>
                  <br />
                  {t.footer.addressText[1]}
                  <br />
                  {t.footer.addressText[2]}
                  <br />
